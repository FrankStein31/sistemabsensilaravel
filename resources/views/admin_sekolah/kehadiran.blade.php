...
<div class="container-fluid">
    <div class="row mb-4">
        <div class="col-md-12 text-end">
            <form action="{{ route('admin_sekolah.kehadiran') }}" method="GET" id="filter-form">
                <div class="input-group">
                    ...
                    <input type="date" name="date" class="form-control me-2" style="width: 300px;" placeholder="Pilih Tanggal" value="{{ request('date', now()->toDateString()) }}">
