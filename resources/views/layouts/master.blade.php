    ...
    <div class="sidebar">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                <li class="nav-item">
                    <a href="{{ route('admin_sekolah.dashboard') }}" class="nav-link">
                        <p>Dashboard</p>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="{{ route('admin_sekolah.manajemendatasiswa') }}" class="nav-link">
                        <p>Manajemen Data Siswa</p>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="{{ route('admin_sekolah.kehadiran') }}" class="nav-link">
                        <p>Data Presensi Siswa</p>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="{{ route('student_attendances.index') }}" class="nav-link">
                        <p>Data Rekap Presensi Siswa</p>
                    </a>
                </li>
                <li class="nav-item">
